...
import { containerStyle,
	...
	applyBtnStyle,} from './MainPage'; // 스타일 파일 경로에 따라 수정하세요
import FixFrame from './FixFrame.js';
import { ErrorFunc, TokenGetter } from './App.js';
import OrderedDetailToMobile from './OrderedDetailToMobile.js';
import ImageWithDescriptionToMobile from './ImageWithDescriptionToMobile.js';
...
const MyPageToMobile = () => {
	...
	<div style={containerStyle}>
		...
		{/*///////////////////////////////////////////////*/}
			...
			<div>
				<div>
					<h3 style={{marginTop:'80px', marginLeft:"10px",}}>최근 주문내역</h3>
						<hr style={{
							marginTop: '10px',
							marginBottom: '20px',
						...
						<h3 style={{marginTop: '50px', marginLeft:"10px",}}>Like ♡</h3>
						<hr style={{ marginLeft: '0px', marginTop: '15px', marginBottom: '-80px', borderBottom: '2px solid #424242', width:'100%' }}></hr><br/>
						
						<div style={heartListStyle}>
							{heartList.length > 0 ? (
							heartList.map((imageInfo, index) => (
								<ImageWithDescriptionToMobile
									key={index}
